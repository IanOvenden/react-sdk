...
test.describe('E2E test', () => {
  test(
    'Embedded: should launch, select a service plan and fill details',
    async ({ page }, testInfo) => {
      await common.login(config.config.apps.pokerVillains.user.username, config.config.apps.pokerVillains.user.password, page);
